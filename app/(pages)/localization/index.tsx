  ...
  return (
    <div className="mx-auto px-8 py-16 md:p-20 max-w-[100rem]">
      <div className="md:px-14 py-6 font-bold text-center rounded-3xl mx-auto max-w-[40rem]">
        <p className="show-fade text-4xl">Onde nos encontrar</p>
      </div>
      <div className="show-fade anim-delay-400 relative w-full h-[455px]">
      ...
      <div className="show-fade anim-delay-800 flex items-center justify-center text-center gap-8 px-4 py-3 font-bold">
        <p className="leading-none">
          {/* Segunda a Sexta, das 8:00 às 18:00 */}
          <CalendarMonthRounded className="!leading-none" fontSize="inherit" /> Seg - Sex
        </p>
